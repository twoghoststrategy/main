...
<h3 className="order-1 text-3xl font-black oswald">Branding, Strategy, Creative+</h3>
...
<div class="w-full overflow-hidden sm:w-full md:my-2 md:px-2 md:w-1/2 lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
<li className="c-services__item">
                    <h3 className="order-2 text-3xl font-black oswald">Marketing Strategy</h3>
...
<div class="w-full overflow-hidden sm:w-full md:my-2 md:px-2 md:w-1/2 lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
<li className="c-services__item">
                    <h3 className="order-3 text-3xl font-black oswald">Branding</h3>
...
<div class="w-full overflow-hidden sm:w-full md:my-2 md:px-2 md:w-1/2 lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
<li className="c-services__item">
                    <h3 className="order-4 text-3xl font-black oswald">Creative</h3>
...
<div class="w-full overflow-hidden sm:w-full md:my-2 md:px-2 md:w-1/2 lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
<li className="c-services__item">
                    <h3 className="order-5 text-3xl font-black oswald">Content </h3>
...
<div class="w-full overflow-hidden sm:w-full md:my-2 md:px-2 md:w-1/2 lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
<li className="c-services__item">
                    <h3 className="order-6 text-3xl font-black oswald">Website & Martech</h3>
                    <p><em>
