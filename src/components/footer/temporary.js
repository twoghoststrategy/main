...
<div className="ml-16 text-gray-50 oswald wow fadeInLeft place-content-right place-items-left sm:place-items-center"
                            data-wow-delay="0ms"
                            data-wow-duration="1000ms">
                            <p className=""><span className="text-2xl font-black stroke-1 text-stroke-1 text-stroke-white stroke-white gradienttext raleway place-content-center xl:place-content-right lg:place-content-right sm:place-items-center sm:place-content-center md:place-content-center lg:place-items-right xl:place-items-right">TWOGHOSTS LLC</span><br /><FontAwesomeIcon className="text-gray-50 oswald" icon={faHome} /><span className="ml-10 oswald">PO Box 80612</span><br /><span className="pl-5 ml-10 oswald">Raleigh, NC 27675</span><br /><a className="text-gray-50" href="tel:9198234333"><FontAwesomeIcon className="text-gray-50" icon={faPhone} /><span className="ml-10 oswald hover:text-white">919.823.4333</span></a></p>
                        </div>
...
<div className="text-gray-50 oswald ft-info wow fadeInLeft place-content-center xl:place-content-right lg:place-content-right sm:place-items-center sm:place-content-center md:place-content-center lg:place-items-right xl:place-items-right"
                            data-wow-delay="300ms"
                            data-wow-duration="1000ms">


                            <div className="text-gray-50 oswald lg:inline xl:inline ft-info wow fadeInLeft"
                            data-wow-delay="600ms"
                            data-wow-duration="1000ms">
                               <div className="mt-8 xl:mt-0">
                        <h3 className="font-bold tracking-wider text-gray-200 text-md oswald">
