module.exports = {
    siteUrl: `https://www.oakwave.com`, // Site domain. Do not include a trailing slash!

    postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

    siteTitleMeta: `OAKwave Creative, Branding, and Digital`, // This allows an alternative site title for meta data for pages.
    ...
    shortTitle: `OAKwave`, // Used for App manifest e.g. Mobile Home Screen
